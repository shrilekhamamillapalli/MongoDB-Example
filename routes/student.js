...
router.put('/updateStudent', (req, res) => {
  ...
  db.updateOne({ "_id": mongo.ObjectID(id) }, update_data, function (err) {
                  ...
                  if (err) {
                      ...
                      res.json(response);
                              ...
                              if (err) {
                                  ...
                                  response = { success: true, msg: "Student deleted successfully.:"+stu_id };
                              }
                              res.json(response);
                  ...
                  if (err) {
                      ...
                      res.json(response);
                              ...
                              if (err) {
                                  ...
                                  response = { success: true, msg: "Student deleted successfully.:"+email_id };
                              }
                              res.json(response);
